    ...
    def test(self):
        ...
        with torch.no_grad():
            for batch_num, (data, target) in enumerate(self.testing_loader):
                ...
                PSNR = skimage.measure.compare_psnr(prediction_array[0,0,:,:], target_array[0,0,:,:], data_range=1)
...
def main():
    ...
    resultPSNR, resultSSIM = SRCNNTrainer(args, training_data_loader, testing_data_loader).run()
